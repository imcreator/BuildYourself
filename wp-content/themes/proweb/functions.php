...
function proweb_setup() {
	 ...
	 */
	load_theme_textdomain( 'proweb', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'proweb_custom_background_args', array(
...
function proweb_scripts() {
	...
	wp_enqueue_script( 'proweb-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'proweb-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
