...
function travelify_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Travelify Travel', 'travelify' ),
		'id'            => 'travelify_travel_widget',
	...
	register_sidebar( array(
		'name'          => __( 'Travelify Hunts', 'travelify' ),
		'id'            => 'travelify_hunts_widget',
		'description'   => __( 'Shows widgets at footer.', 'travelify' ),
		'before_widget' => '<div class="col-3"><aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside></div>',
		'before_title'  => '<h3 class="widget-title">',
	...
	register_sidebar( array(
		'name'          => __( 'Travelify Autos', 'travelify' ),
		'id'            => 'travelify_autos_widget',
		'description'   => __( 'Shows widgets at footer.', 'travelify' ),
		'before_widget' => '<div class="col-3"><aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside></div>',
		'before_title'  => '<h3 class="widget-title">',
